...
public class PetController {
    ...
    private void initEvents() {
        ...
        com.pethotel.utils.NavigationHelper.attachMenuEvents(
                view.getBtnMenuBooking(), // Nút Booking
                null,                     // Nút Pet (Đang ở đây -> null)
                view.getBtnMenuCage(),    // Nút Cage
                view.getBtnMenuService(), // Nút Service
                view.getBtnMenuAccount(),    // Nút User
                view.getMainPanel()
        );
    }
