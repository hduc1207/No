...
public class ServiceController {
    ...
    private void initEvents() {
        ...
        view.getTblService().addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (row >= 0) {
                    ...
                    // GUI dichvu hiện tại không có trường nhập Unit (Đơn vị),
                    // nếu có bạn hãy setText cho nó ở đây.
                }
            }
        });
        ...
        com.pethotel.utils.NavigationHelper.attachMenuEvents(
                ...
                view.getBtnMenuPet(),
                view.getBtnMenuCage(),
                null,                     // Nút Service (Đang ở đây -> null)
    ...
    private ServiceDTO getServiceFromForm() {
        try {
            ...
            // Mặc định đơn vị là "Lần" vì GUI thiếu trường này
            s.setUnit("Lần");
            return s;
