...
public class Main {
    public static void main(String[] args) {
        ...
        // 2. TỰ ĐỘNG TẠO TÀI KHOẢN ADMIN (Nếu chưa có)
        // Giúp bạn đăng nhập lần đầu mà không cần chạy lệnh SQL tay
    ...
    private static void checkAndCreateDefaultAdmin() {
        ...
        // Lưu ý: Nếu CSDL của bạn cột FullName không cho null thì cần thêm vào, nếu cho null thì bỏ qua.
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            if (rs.next() && rs.getInt(1) == 0) {
                // Nếu chưa có (count = 0) -> Tạo mới
                PreparedStatement pstInsert = conn.prepareStatement(insertSql);
                pstInsert.setString(1, "admin");
                pstInsert.setString(2, "123456"); // Mật khẩu mặc định
                pstInsert.setString(3, "Admin");
                pstInsert.setString(4, "Administrator"); // Tên hiển thị
