...
public class PetDAO {
    ...
    public List<PetDTO> getPetsByCustomerId(int customerId) {
        List<PetDTO> list = new ArrayList<>();
        String sql = "SELECT * FROM Pets WHERE CustomerID = ?";
    ...
    public boolean insertPet(PetDTO pet) {
        String sql = """
                INSERT INTO Pets (PetName, Type, Breed, Weight, HealthStatus, CustomerID)
                VALUES (?, ?, ?, ?, ?, ?)
                """;
    ...
    public boolean updatePet(PetDTO pet) {
        String sql = """
                UPDATE Pets
                SET PetName = ?, Type = ?, Breed = ?, Weight = ?, HealthStatus = ?, CustomerID = ?
                WHERE PetID = ?
                """;
